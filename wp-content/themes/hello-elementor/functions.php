...
/* Projektant sekce na kontaktní stránce */
...
// Projektant bar ve footeru + sekce na kontaktní stránce
...
<div id="am-projektant-kontakt">
    <div class="am-pk-inner">
        <img src="' . $logo . '" alt="ZrobiM-ek s.r.o.">
...
<div id="am-projektant-bar">
    ...
    <div>
        <span class="am-proj-label">Projektant projektu:</span>
